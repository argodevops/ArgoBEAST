...
def init():
    ...
    while not user_input:
        include_examples = input("Would you like to include example files within the directories? [Y]es,[N]o: ")
    ...
    user_input = False
    while not user_input:
        install_deps = input("Would you like to attempt to install the required dependencies? [Y]es,[N]o: ")
